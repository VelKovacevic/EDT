                ...
                if(selectID == 0){
                    ...
                    switch (droit) {
                        case 3:
                            ...
                            seanceAnnule = Funtions.seancesEnseignant(selectID, 2, debut, fin);
                            
                            new Edt(seanceAnnule, seances, debut, selectID, nom + " " + prenom, 2);
                        ...
                        case 4:
                            ...
                            seanceAnnule = Funtions.seancesUtilisateur(selectID, 2, debut, fin);
                            new Edt(seanceAnnule, seances, debut, selectID, nom + " " + prenom, 1);
                            this.setVisible(false);
                            this.dispose();
                            break;
                        case 2:
